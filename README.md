...
3. You will need to install rtools, which is a separate program that helps to build some packages from source. Check the rtools that is compatible with your R.
4. Now, using the pacman package, run the following:
